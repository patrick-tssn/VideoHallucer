...
class VideoChat(ViLLMBaseModel):
    def __init__(self, model_args):
        ...
        cfg.model.llama_model_path = os.path.join(model_args["model_path"], "vicuna-7b-delta-v0")
    ...
    def generate(self, instruction, video_path):
        ...
        ask(instruction, chat)

        llm_message = answer(conv=chat, model=self.model, do_sample=False, img_list=img_list, max_new_tokens=256, print_res=True)[0]
        # print(llm_message)
